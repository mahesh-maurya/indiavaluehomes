...
define('WEBSITE', 'www.indiavaluehomes.com'); // Used in pdf emails to let your customers know where they came from 
define('URL', 'http://localhost/indiavalue/morgage');  // Used for scripts and file reference locations (include http://), no trailing slashes
