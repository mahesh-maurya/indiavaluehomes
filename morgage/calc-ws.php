...
define(\'DISCLAIMER\', \'' . $disclaimer . '\');';
        ...
        $jsonData['blurb'] =  "<div class='blurb'><p>Down Payment: <b>INR $moneydown2</b><br>";
        $mortgage = $price - $moneydown;
        $mortgage2 = number_format ($mortgage, 2);
        $jsonData['blurb'] .=  "Mortgage amount after down payment: <b>INR $mortgage2</b><br>";
        ...
        $jsonData['blurb'] .=  "Monthly Payment: <b>INR $monthly_payment2</b> (Principal and Interest Only)<br>";
        ////////////////////////////////////
